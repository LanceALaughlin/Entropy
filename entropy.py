...
class ProcessImage(object):
	...
	def output(self): #Probably only print this in verbose mode in the future
		...
		try:
			...
			print '\033[95m' + "White: Pixel (0,0) fails to calculate"

		try:
			print '\033[91m' + "Red: Pixel (0,1) color temp:", self.calcPixelTemp(self.image.getpixel((0,1)))
		except:
			print '\033[91m' + "Red: Pixel (0,1) fails to calculate"

		try:
			print '\033[94m' + "Blue: Pixel (1,0) color temp:", self.calcPixelTemp(self.image.getpixel((1,0)))
		except:
			print '\033[94m' + "Blue: Pixel (1,0) fails to calculate"

		try:
			print '\033[93m' + "Black: Pixel (1,1) color temp:", self.calcPixelTemp(self.image.getpixel((1,1)))
		except:
			print '\033[93m' + "Black: Pixel (1,1) fails to calculate"
